...
export function Footer() {
  return (
    <footer className="bg-background pt-20 pb-10 border-t border-border/40 relative z-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-foreground/60 mb-6">
              The AI teammate that never forgets. Transform engineering knowledge into intelligent memory.
            </p>
            <div className="flex items-center gap-4 text-foreground/50">
              ...
              <Link href="#" className="hover:text-white transition-colors"><LinkedinIcon className="w-5 h-5" /></Link>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-border/40 text-center md:text-left text-sm text-foreground/40 flex flex-col md:flex-row justify-between items-center">
          <p>© 2026 RecallIQ. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
