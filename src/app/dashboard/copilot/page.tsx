                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {msg.sources.map((src, i) => (
                            <span 
                              key={i} 
                              className="text-[9px] font-mono px-2 py-0.5 rounded bg-white/5 border border-white/10 text-white/60 hover:text-primary hover:border-primary/50 cursor-pointer flex items-center gap-1.5 transition-colors"
                            >
                              {src.name}
